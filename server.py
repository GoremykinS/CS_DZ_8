...
from common.variables import ACTION, ACCOUNT_NAME, RESPONSE, MAX_CONNECTIONS, PRESENCE, TIME, USER, ERROR, MESSAGE, MESSAGE_TEXT, DEFAULT_PORT, RESPONSE_400, DESTINATION, RESPONSE_200, EXIT
